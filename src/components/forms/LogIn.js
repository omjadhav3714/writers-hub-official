...
import illustration from "./../../images/forget.svg";
import Lottie from 'react-lottie';
import animationData from './../../lottie/login';
        ...
        <Container>
          <Content>
            <MainContainer>
              ...
              <MainContent>
                <Heading>Sign in to writershub</Heading>
                <FormContainer>
                  ...
                  <p tw="mt-6 text-xs text-gray-600 text-center">
                    <a href="/resetpassword" tw="border-b border-gray-500 ">
                      Forgot Password ?
                    </a>
                  </p>
                  <p tw="mt-8 text-sm text-gray-600 text-center">
                    Dont have an account?{" "}
                    <a href="/signup" tw="border-b border-gray-500">
                      Sign Up
                    </a>
                  </p>
                </FormContainer>
