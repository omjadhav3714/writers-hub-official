            ...
            >
                <div className='about-section'>
                    <div className='inner-container'>
                        ...
                        <p className='text'>
                            Our privacy policy will help you understand what information we collect at Writerhub ,
                            how Writerhub uses it, and what choices you have. Writerhub built the Writerhub  app as a free app.
                            This SERVICE is provided by Writerhub at no cost and is intended for use as is.
                            ...
                            which is accessible in our website, unless otherwise defined in this Privacy Policy.
                        </p>
                        ...
                        <p className='text'>
                            ...
                            sent to your device. If you choose to refuse our cookies, you may not be able to use some portions
                            of this Service.
                        </p>
                        <h2>Location Information</h2>
                        <p className='text'>
                            Some of the services may use location information transmitted from users' mobile phones. We only
                            use this information within the scope necessary for the designated service
                        </p>
                        ...
                        <p className='text'>
                            We collect information from your device in some cases. The information will be utilized
                            for the provision of better service and to prevent fraudulent acts. Additionally, such
                            information will not include that which will identify the individual user.
                        </p>
                        <h2>Security</h2>
                        <p className='text'>
                        ...
                        <p className='text'>
                            ...
                            Email: <a target='__blank' href="mailto:writershubofficial@gmail.com">writershubofficial@gmail.com</a> </p>
